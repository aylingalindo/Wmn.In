              ...
              <div class="carousel-item">
                <div class="row g-3 justify-content-center">
                    ...
                    <div class="col-12 mb-3">
                        <input type="file" class="form-control" name="profileImgSignup" required>
                        <div class="invalid-feedback">
                            Select an image.
                        </div>
                    </div>
              ...
              <div class="carousel-item">
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <input type="password" class="form-control" id="passConfirm" value="" required >
                        <div class="invalid-feedback">
        ...
        <div class="card">
          <div class="card-body">
            <form action="loginServlet" method="post" class="needs-validation" novalidate>
              <input type="email" class="form-control mb-3" id="usernameLogin" name="nameLogin" placeholder="name@example.com" required>
